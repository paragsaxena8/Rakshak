...
$docs = array(
	...
	'PHPIDS-license' => array( 'legend' => 'PHPIDS License', 'file' => RAKSHAK_WEB_PAGE_TO_PHPIDS . 'LICENSE' ),
);
...
$instructions = file_get_contents( RAKSHAK_WEB_PAGE_TO_ROOT.$readFile );

function urlReplace( $matches ) {
	return RAKSHAKExternalLinkUrlGet( $matches[1] );
}
