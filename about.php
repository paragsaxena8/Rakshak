...
<div class=\"body_padded\">
	...
	<p>WebVuln Vulnerable Web Application (WebVuln) is a PHP/MySQL web application that is WebVuln vulnerable. Its main goals are to be an aid for security professionals to test their skills and tools in a legal environment, help web developers better understand the processes of securing web applications and aid teachers/students to teach/learn web application security in a class room environment</p>
	<p>The official documentation for WebVuln can be found <a href=\"docs/WebVuln_v1.3.pdf\">here</a>.</p>
	...
	<h2>License</h2>
	<p>WebVuln Vulnerable Web Application (WebVuln) is free software: you can redistribute it and/or modify
	it under the terms of the GNU General Public License as published by
	the Free Software Foundation, either version 3 of the License, or
	(at your option) any later version.</p>
	<p>The PHPIDS library is included, in good faith, with this WebVuln distribution. The operation of PHPIDS is provided without support from the WebVuln team. It is licensed under <a href=\"" . RAKSHAK_WEB_PAGE_TO_ROOT . "instructions.php?doc=PHPIDS-license\">separate terms</a> to the WebVuln code.</p>

	<h2>Development</h2>
	<p>Everyone is welcome to contribute and help make WebVuln as successful as it can be. All contributors can have their name and link (if they wish) placed in the credits section. To contribute pick an Issue from the Project Home to work on or submit a patch to the Issues list.</p>
</div>\n";
