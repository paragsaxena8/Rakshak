...
<div class=\"body_padded\">
	<h1>WebVuln Security <img src=\"" . RAKSHAK_WEB_PAGE_TO_ROOT . "RAKSHAK/images/lock.png\" /></h1>
	<br />
	...
	<form action=\"#\" method=\"POST\">
		{$securityLevelHtml}
		<p>You can set the security level to low, medium, high or No Security. The security level changes the vulnerability level of WebVuln:</p>
		<ol>
			...
			<li> No Security - This level should be <em>secure against all vulnerabilities</em>. It is used to compare the vulnerable source code to the secure source code.<br />
				Prior to WebVuln v1.9, this level was known as 'high'.</li>
		</ol>
	...
	<p>PHPIDS works by filtering any user supplied input against a blacklist of potentially malicious code. It is used in WebVuln to serve as a live example of how Web Application Firewalls (WAFs) can help improve security and in some cases how WAFs can be circumvented.</p>
