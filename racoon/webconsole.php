...
?>
    ...
    <head>
        ...
        <meta name="description" content="Web Console (http://https://cybersquareinfo.com/)" />
        <meta name="author" content="Parag Saxena (http://paragsaxena.tech)" />
    ...
    <body>
        <div class="configure">
            ...
            <p>For more information visit Web Console website: <a href="http://cybersquareinfo.com">http://cybersquareinfo.com</a></p>
        </div>
    </body>
...
<?php
    ...
    <head>
        <meta charset="utf-8" />
        <meta http-equiv="X-UA-Compatible" content="IE=edge" />
        <title>Web Console | Rakshak</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta name="description" content="Web Console (https://cybersquareinfo.com/)" />
        <meta name="author" content="Parag Saxena (https://paragsaxena.tech)" />
        <meta name="robots" content="none" />
        <style type="text/css">
            html {
                font-family: sans-serif;
...
RAKSHAK
To Run the Tool, use command : 'python rakshak'
To Pass arugment, for choice use -c CHOICE  for target use -t TARGET
Eg: python rakshak -c 0 -t iparagsaxena.com
Options:
1. Censys
2. NS lookup
3. Port scan
