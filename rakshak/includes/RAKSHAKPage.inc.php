...
if( !defined( 'RAKSHAK_WEB_PAGE_TO_ROOT' ) ) {
	die( 'WebVuln System error- WEB_PAGE_TO_ROOT undefined' );
	exit;
}
...
if (!file_exists(RAKSHAK_WEB_PAGE_TO_ROOT . 'config/config.inc.php')) {
	die ("WebVuln System error - config file not found. Copy config/config.inc.php.dist to config/config.inc.php and configure to your environment.");
}
...
function &RAKSHAKPageNewGrab() {
	$returnArray = array(
		'title'           => 'WebVuln Vulnerable Web Application (WVWA) v' . RAKSHAKVersionGet() . '',
		'title_separator' => ' :: ',
		'body'            => '',
		'page_id'         => '',
		'help_button'     => '',
...
function RAKSHAKHtmlEcho( $pPage ) {
	...
	if( RAKSHAKIsLoggedIn() )  {
		...
		$menuBlocks[ 'home' ][] = array( 'id' => 'setup', 'name' => 'Setup WebVuln', 'url' => 'setup.php' );
		$menuBlocks[ 'home' ][] = array( 'id' => 'instructions', 'name' => 'Instructions', 'url' => 'instructions.php' );
	}
                        ...
                        <div class=\"navbar-header\">
                            <a href=\"./\" class=\"navbar-brand\">
                                <div class=\"brand-image brand-big\">
                                    <img src=\"assets/images/logo.png\" alt=\"logo\" class=\"logo-big\">
                                </div>
