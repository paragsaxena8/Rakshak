...
$page[ 'body' ] .= "
	...
	<ul>
		<li>" . RAKSHAKExternalLinkUrlGet( 'https://www.w3schools.com/js/' ) . "</li>
		<li>" . RAKSHAKExternalLinkUrlGet( 'https://www.youtube.com/watch?v=cs7EQdWO5o0&index=17&list=WL' ) . "</li>
		<li>" . RAKSHAKExternalLinkUrlGet( 'https://ponyfoo.com/articles/es6-proxies-in-depth' ) . "</li>
	</ul>
