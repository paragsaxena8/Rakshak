<div class="body_padded">
	...
	<td><div id="code">
		...
		<h3>Objective</h3>
		<p>This module uses four different ways to set the RAKSHAKSession cookie value, the objective of each level is to work out how the ID is generated and then infer the IDs of other system users.</p>
	...
	<p>Reference: <?php echo RAKSHAKExternalLinkUrlGet( 'https://www.owasp.org/index.php/Top_10_2013-A2-Broken_Authentication_and_Session_Management' ); ?></p>
</div>
