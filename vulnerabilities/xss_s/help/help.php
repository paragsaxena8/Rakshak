<div class="body_padded">
	...
	<td><div id="code">
		...
		<p>Using inbuilt PHP functions (such as "<?php echo RAKSHAKExternalLinkUrlGet( 'https://secure.php.net/manual/en/function.htmlspecialchars.php', 'htmlspecialchars()' ); ?>"),
	...
	<p>Reference: <?php echo RAKSHAKExternalLinkUrlGet( 'https://www.owasp.org/index.php/Cross-site_Scripting_(XSS)' ); ?></p>
</div>
