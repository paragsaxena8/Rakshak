...
$source = @file_get_contents( RAKSHAK_WEB_PAGE_TO_ROOT . "vulnerabilities/{$id}/source/{$security}.php" );
$source = str_replace( array( '$html .=' ), array( 'echo' ), $source );

$js_html = "";
if (file_exists (RAKSHAK_WEB_PAGE_TO_ROOT . "vulnerabilities/{$id}/source/{$security}.js")) {
	$js_source = @file_get_contents( RAKSHAK_WEB_PAGE_TO_ROOT . "vulnerabilities/{$id}/source/{$security}.js" );
	$js_html = "
...
<div class=\"body_padded\">
	...
	<form>
		<input class=\"form-control\"  type=\"button\" value=\"Compare All Levels\" onclick=\"window.location.href='view_source_all.php?id=$id'\">
	</form>
</div>\n";
