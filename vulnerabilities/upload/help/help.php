<div class="body_padded">
	...
	<td><div id="code">
		...
		<h3>Objective</h3>
		<p>Execute any PHP function of your choosing on the target system (such as <?php echo RAKSHAKExternalLinkUrlGet( 'https://secure.php.net/manual/en/function.phpinfo.php', 'phpinfo()' ); ?>
			or <?php echo RAKSHAKExternalLinkUrlGet( 'https://secure.php.net/manual/en/function.system.php', 'system()' ); ?>) thanks to this file upload vulnerability.</p>
	...
	<p>Reference: <?php echo RAKSHAKExternalLinkUrlGet( 'https://www.owasp.org/index.php/Unrestricted_File_Upload' ); ?></p>
</div>
