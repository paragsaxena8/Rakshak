<div class="body_padded">
	...
	<td><div id="code">
		...
		<p>Using a <?php echo RAKSHAKExternalLinkUrlGet( 'https://en.wikipedia.org/wiki/CAPTCHA', 'CAPTCHA' ); ?> form could have a similar effect as a CSRF token.</p>
	...
	<p>Reference: <?php echo RAKSHAKExternalLinkUrlGet( 'https://en.wikipedia.org/wiki/Password_cracking' ); ?></p>
</div>
