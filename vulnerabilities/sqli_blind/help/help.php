<div class="body_padded">
	...
	<td><div id="code">
		...
		<p>The medium level uses a form of SQL injection protection, with the function of
			"<?php echo RAKSHAKExternalLinkUrlGet( 'https://secure.php.net/manual/en/function.mysql-real-escape-string.php', 'mysql_real_escape_string()' ); ?>".
	...
	<p>Reference: <?php echo RAKSHAKExternalLinkUrlGet( 'https://www.owasp.org/index.php/Blind_SQL_Injection' ); ?></p>
</div>
