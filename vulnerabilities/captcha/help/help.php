<div class="body_padded">
	...
	<td><div id="code">
		<h3>About</h3>
		<p>A <?php echo RAKSHAKExternalLinkUrlGet( 'https://en.wikipedia.org/wiki/CAPTCHA', 'CAPTCHA' ); ?> is a program that can tell whether its user is a human or a computer. You've probably seen
	...
	<p>Reference: <?php echo RAKSHAKExternalLinkUrlGet( 'https://en.wikipedia.org/wiki/CAPTCHA' ); ?></p>
</div>
