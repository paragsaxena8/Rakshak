...
$page[ 'body' ] .= "
	...
	<ul>
		<li>" . RAKSHAKExternalLinkUrlGet( 'http://www.scribd.com/doc/2530476/Php-Endangers-Remote-Code-Execution' ) . "</li>
		<li>" . RAKSHAKExternalLinkUrlGet( 'http://www.ss64.com/bash/' ) . "</li>
		<li>" . RAKSHAKExternalLinkUrlGet( 'http://www.ss64.com/nt/' ) . "</li>
		<li>" . RAKSHAKExternalLinkUrlGet( 'https://www.owasp.org/index.php/Command_Injection' ) . "</li>
	</ul>
</div>\n";
