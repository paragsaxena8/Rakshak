<div class="body_padded">
	...
	<td><div id="code">
		...
		<pre>Spoiler: <span class="spoiler"><?php echo RAKSHAKExternalLinkUrlGet( 'https://secure.php.net/manual/en/function.trim.php', 'trim()' ); ?>
	...
	<p>Reference: <?php echo RAKSHAKExternalLinkUrlGet( 'https://www.owasp.org/index.php/Command_Injection' ); ?></p>
</div>
