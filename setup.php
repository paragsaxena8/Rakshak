...
if( isset( $_POST[ 'create_db' ] ) ) {
	...
	if( $DBMS == 'MySQL' ) {
		include_once RAKSHAK_WEB_PAGE_TO_ROOT . 'RAKSHAK/includes/DBMS/MySQL.php';
	}
	elseif($DBMS == 'PGSQL') {
		// include_once RAKSHAK_WEB_PAGE_TO_ROOT . 'RAKSHAK/includes/DBMS/PGSQL.php';
		RAKSHAKMessagePush( 'PostgreSQL is not yet fully supported.' );
		RAKSHAKPageReload();
	}
	else {
		RAKSHAKMessagePush( 'ERROR: Invalid database selected. Please review the config file syntax.' );
		RAKSHAKPageReload();
	}
}
...
<div class=\"body_padded\">
	<h1>Database Setup <img src=\"" . RAKSHAK_WEB_PAGE_TO_ROOT . "RAKSHAK/images/spanner.png\" /></h1>
